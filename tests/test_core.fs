...
create stack-values 5 cells allot

: save-stack-3
  stack-values 2 cells + !
  stack-values 1 cells + !
  stack-values            !
;
...
T{ restore-stack-3 -> 11111 0 22222 }T    \ 0 comes from RESTORE-INPUT
...
: save-stack-5
  stack-values 4 cells + !
  stack-values 3 cells + !
  stack-values 2 cells + !
  stack-values 1 cells + !
  stack-values            !
;
...
save-stack-5
 ...
 T{ restore-stack-5 -> 0 0 2345 44444 55555 }T
